...
print(f"The number of benchmark points that don't have v3 global min at 50GeV is: {len(v3NotGlobalMinBm)}")
print(f"The number of benchmark points that are unbounded at finite T is: {len(unBoundedBm)}")
...
plt.scatter(passedBm[2], passedBm[0], s = 4.2**2, c="green", label = "okay")
plt.scatter(v3NotGlobalMinBm[2], v3NotGlobalMinBm[0], s = 4.2**2, c="blue", label = "v3NotGlobal")
...
plt.scatter(passedBm[2], passedBm[1], s = 4.2**2, c="green", label = "okay")
plt.scatter(v3NotGlobalMinBm[2], v3NotGlobalMinBm[1], s = 4.2**2, c="blue", label = "v3NotGlobal")
...
plt.scatter(passedBm[2], passedBm[3], s = 4.2**2, c="green", label = "okay")
plt.scatter(v3NotGlobalMinBm[2], v3NotGlobalMinBm[3], s = 4.2**2, c="blue", label = "v3NotGlobal")
...
plt.scatter(passedBm[2], passedBm[4], s = 4.2**2, c="green", label = "okay")
plt.scatter(v3NotGlobalMinBm[2], v3NotGlobalMinBm[4], s = 4.2**2, c="blue", label = "v3NotGlobal")
...
plt.scatter(passedBm[2], passedBm[5], s = 4.2**2, c="green", label = "okay")
plt.scatter(v3NotGlobalMinBm[2], v3NotGlobalMinBm[5], s = 4.2**2, c="blue", label = "v3NotGlobal")
