...
print(f"Number of benchmarks that were strong at one loop but aren't at 2 loop: {becomeWeakCount}")
print(f"Number of benchmarks that become stronger at 2 loop: {len(pdDifP)}")
print(f"Number of benchmarks that become weaker at 1 loop: {len(pdDifM) + becomeWeakCount}")
