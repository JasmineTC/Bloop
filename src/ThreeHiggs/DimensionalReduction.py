...
class DimensionalReductionUnitTest(TestCase):
    ...
    def test_getEFTParamsFull(self):
        ...
        dimensionalReduction = DimensionalReduction(ParsedExpressionSystem(pythoniseExpressionSystem(getLines("Data/ModelFiles/Z2_3HDM/HardToSoft/softScaleParams_NLO.txt")), None),
                                                    ParsedExpressionSystem(pythoniseExpressionSystem(getLines("Data/ModelFiles/Z2_3HDM/HardToSoft/softScaleRGE.txt")), None), 
                                                    ParsedExpressionSystem(pythoniseExpressionSystem(getLines("Data/ModelFiles/Z2_3HDM/SoftToUltrasoft/ultrasoftScaleParams_NLO.txt")), None))
