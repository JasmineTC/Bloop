...
class DimensionalReductionUnitTest(TestCase):
    ...
    def test_getEFTParamsFull(self):
        ...
        dimensionalReduction = DimensionalReduction(ParsedExpressionSystem(pythoniseExpressionSystem(getLines("Data/Z2_3HDM/ModelFiles/HardToSoft/softScaleParams_NLO.txt")), None),
                                                    ParsedExpressionSystem(pythoniseExpressionSystem(getLines("Data/Z2_3HDM/ModelFiles/HardToSoft/softScaleRGE.txt")), None), 
                                                    ParsedExpressionSystem(pythoniseExpressionSystem(getLines("Data/Z2_3HDM/ModelFiles/SoftToUltraSoft/ultrasoftScaleParams_NLO.txt")), None))
